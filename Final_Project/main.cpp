...
template <class T>void thank_you(T a){
    cout<<"\t\t\t\tTHANK YOU VERY MUCH FOR SEEING THIS PROJECT";
    cout<<"\nDate:"<<a<<"/05/2023.";
}
class vinyls{
    int sum_vinyl;
...
public:
    ...
    void Display_vinyls(){
        ...
        if(ch==1){
            ...
            cout<<"\t\t\t\t\t1.Flame 1.($350)"<<endl;
            cout<<"\t\t\t\t\t2.Flame 2.($400)"<<endl;
            cout<<"\t\t\t\t\t3.Flame 3.($450)"<<endl;
        }
        if(ch==2){
            cout<<"\n\t\t\t\tAvailable Tribal:"<<endl;
            cout<<"\t\t\t\t\t1.Tribal 1($250)."<<endl;
            cout<<"\t\t\t\t\t2.Tribal 2($300)."<<endl;
            cout<<"\t\t\t\t\t3.Tribal 3($350)."<<endl;
        }
        if(ch==4){
            cout<<"\n\t\t\t\tAvailable Stripe:"<<endl;
            cout<<"\t\t\t\t\t1.Stripe 1($350)."<<endl;
            cout<<"\t\t\t\t\t2.Stripe 2($400)."<<endl;
            cout<<"\t\t\t\t\t3.Stripe 3($450)."<<endl;
        }
        if(ch>4){
...
public:
    ...
    void display_bodykits(){
        cout<<"\n\t\t1.For Body Kits:=\n";
        cout<<"\n\t\t\tAvailable Body Kits:\n";
        cout<<"\t\t\t\t1.Stock($1000)"<<endl;
        cout<<"\t\t\t\t2.SUV($2000)"<<endl;
        cout<<"\t\t\t\t3.Super Car($2050)"<<endl;
        cout<<"\t\t\t\t4.Electric($2099)"<<endl;
    }
    int sum_bodykits(){
        return sum;
    }
...
public:
    ...
    void display_spoilers(){
        cout<<"\n\t\t2.For Spoilers:=\n";
        cout<<"\n\t\t\tAvailable Spoilers:\n";
        cout<<"\t\t\t\t1.Viper.($1450)"<<endl;
        cout<<"\t\t\t\t2.Ripper.($1550)"<<endl;
        cout<<"\t\t\t\t3.Banshee.($1650)"<<endl;
    }
    int sum_spoilers(){
        return sum;
    }
...
int main(){
    ...
    string str,name;
    cout<<"\t\t\t\t\t\tWELCOME"<<endl;
    cout<<"\t\t\t\tJAYPEE INSTITUTE OF INFORMATION TECHNOLOGY-128"<<endl;
    cout<<"\n";
    cout<<"\t\t\t\t\t\tProject"<<endl;
    cout<<"\t\t\t\tCar Customization/Modification System";
    cout<<"\n\t\t\t\tEnter Your Name:";
    getline(cin,name);
    cout<<"\n\n";
    ...
    cout<<x.single()<<"\t\t\t\t||"<<endl;
    cout<<"||\t\t\t\t\t\t\t\t\t\t||"<<endl;
    cout<<"||\t\t\t\t\tTotal Sum=$"<<(x.single())*num<<"(Kindly Pay)\t\t||";
    cout<<"\n=================================================================================="<<endl;
    MYSQL* conn;
    MYSQL_ROW row;
    MYSQL_RES* res;
    conn=mysql_init(NULL);
    if(!mysql_real_connect(conn,"localhost","root","82025840","car",0,NULL,0)){
